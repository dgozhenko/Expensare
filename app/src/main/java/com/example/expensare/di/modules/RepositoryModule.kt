...
class RepositoryModule {
    ...
    @Singleton
    @Provides
    fun providesRequestInterface(): RequestInterface {
        return RequestDataSource()
    }

    @Singleton
    @Provides
    fun providesRequestDataSource(): RequestDataSource {
        return RequestDataSource()
    }

    @Singleton
    @Provides
    fun providesRequestRepository(requestInterface: RequestInterface): RequestRepository {
        return RequestRepository(requestInterface)
    }

    @Singleton
    @Provides
    fun providesAcceptHandler(requestRepository: RequestRepository): acceptHandler {
        return acceptHandler(requestRepository)
    }

    @Singleton
    @Provides
    fun providesGetPendingRequests(requestRepository: RequestRepository): getPendingRequests {
        return getPendingRequests(requestRepository)
    }
