...
@Database(entities = [ExpenseEntity::class, GroupEntity::class, ListItemEntity::class, ManualDebtEntity::class, RequestEntity::class, SecondUserEntity::class, UserDebtEntity::class, UserEntity::class], version = 1, exportSchema = false)
