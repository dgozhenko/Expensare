    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.debt_history -> {
                ...
                findNavController()
                    .navigate(
                        DashboardFragmentDirections.actionDashboardFragmentToMyHistoryFragment()
                    )
            }
            R.id.settings -> {
                drawer.closeDrawer(GravityCompat.START)
            ...
            viewLifecycleOwner,
            {
                when (it.status) {
                    ...
                    Status.SUCCESS -> {
                        ...
                        val drawerHeaderNameText =
                            header.findViewById<MaterialTextView>(R.id.user_name)
                        ...
                        val drawerStatusText =
                            header.findViewById<MaterialTextView>(R.id.user_status)
