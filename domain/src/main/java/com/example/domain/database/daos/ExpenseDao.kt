...
interface ExpenseDao {
  ...
  @Query("SELECT * FROM expense") suspend fun getExpenses(): List<ExpenseEntity>

  @Query("UPDATE expense SET uploaded = :uploaded") suspend fun updateUploadInfo(uploaded: Boolean)
}
